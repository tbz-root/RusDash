...
$execute {
    ...
    registerBadge(
        "bk"_spr, "...", "pizdec.",
        [] (const Badge& badge) { handleBadgeCheck(badge, "bk", "bk01_badge.png"_spr); }
    );

    registerBadge(
        "bk02"_spr, "...", "ni ebu che skazat.",
        [] (const Badge& badge) { handleBadgeCheck(badge, "bk02", "bk02_badge.png"_spr); }
    );

    registerBadge(
        "bk03"_spr, "...", "ebaaat...",
        [] (const Badge& badge) { handleBadgeCheck(badge, "bk03", "bk03_badge.png"_spr); }
    );

    registerBadge(
        "top01"_spr, "Top Grinder Badge", "The badge for the best star grinder!",
        [] (const Badge& badge) { handleBadgeCheck(badge, "top01", "top01_badge.png"_spr); }
    );
